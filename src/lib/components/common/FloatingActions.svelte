...
{#if showToast}
	<div class="fixed bottom-8 left-1/2 z-50 -translate-x-1/2 animate-fade-in rounded-lg border border-border/50 bg-card px-4 py-2.5 text-sm text-muted-foreground shadow-lg backdrop-blur-sm">
